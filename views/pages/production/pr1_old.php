...
<body class="bg-custom container-fluid p-3">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Refresh button -->
                    <button id="refreshBtn" type="button" class="btn btn-primary bg-custom-tertiary border-1 rounded-3 fw-medium text-primary glow d-flex">
    ...
    <div class="modal fade" id="delayDetailsModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
            <div class="modal-content">
                <div class="modal-header justify-content-between">
                    <div class="d-flex gap-3 align-items-center">
                       ...
                       <button id="refreshDetailsBtn" type="button" class="btn btn-primary bg-custom-tertiary border-1 rounded-3 fw-medium text-primary glow d-flex">
                            <iconify-icon icon="material-symbols:refresh" width="24" height="24"></iconify-icon>
                            <span class="refreshButton-span btn-span ps-2">Refresh</span>
                        </button>
                    </div>
